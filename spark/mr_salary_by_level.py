"""
=============================================================================
Job 3: mr_salary_by_level.py
Người 3 - Nhóm Thống kê & Thuật toán
Mức độ: TRUNG BÌNH
Kỹ thuật: min, max, avg, stddev, percentile_approx, countDistinct
=============================================================================

MỤC ĐÍCH:
  Thống kê lương theo cấp bậc (job_level) bao gồm:
  - Min, Max, Trung bình, Độ lệch chuẩn
  - Phân vị (Percentile): P25, Median (P50), P75, P90
  → Giúp hiểu phân phối lương ở mỗi cấp bậc

LUỒNG XỬ LÝ (MapReduce logic):
  MAP    → Lọc/làm sạch, extract (job_level, salary_final_vnd)
  REDUCE → groupBy(job_level) → tính toàn bộ thống kê
=============================================================================
"""
